...
const isAlnum = (v) => /^[A-Za-z0-9]{6,16}$/.test(v || "");
...
export default function AuthCard({ mode = "login" }) {
  ...
  const validateSignup = () => {
    ...
    if (!isAlnum(suPw)) errs.password = "Mật khẩu 6–16 chữ cái và số";
    if (suPw !== suPw2) errs.confirm = "Mật khẩu không khớp";
    if (!isAlnum(suTxPw)) errs.tx = "Mật khẩu thanh toán 6–16 chữ cái và số";
        ...
        <Shell onBack={() => navigate("/login")} title="Đăng ký miễn phí">
          ...
          <form onSubmit={submitSignup} className="mt-5 space-y-3">
            ...
            <div>
              ...
              <Helper err={suErr.password}>Vui lòng nhập tổ hợp chữ cái và số từ 6 đến 16 chữ số</Helper>
            </div>
            <div>
              ...
              <Helper err={suErr.confirm}>Vui lòng nhập tổ hợp chữ cái và số từ 6 đến 16 chữ số</Helper>
            </div>
            <div>
              ...
              <Helper err={suErr.tx}>Vui lòng nhập tổ hợp chữ cái và số từ 6 đến 16 chữ số</Helper>
            </div>
