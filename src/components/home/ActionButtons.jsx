...
export default function ActionButtons({ t }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-x-[27px] gap-y-[20px] px-4 mt-[27px] shrink-0">
      {buttons.map((b, i) => (
        <button key={i} className="relative w-full h-[51px] rounded-lg overflow-clip flex items-center justify-center hover:opacity-90 active:scale-95 transition-transform">
