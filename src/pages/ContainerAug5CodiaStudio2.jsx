...
export default function ContainerAug5CodiaStudio2() {
  return (
    <main className="max-w-[522px] w-full mx-auto relative min-h-[1146px] bg-figma-secondary-3 overflow-clip flex flex-col">
      {/* Background */}
      ...
      {/* Close Button */}
      <button className="absolute top-[23px] right-[37px] z-50 w-[26px] h-[27px] hover:opacity-80 transition-opacity">
        <img
      ...
      {/* Form */}
      <div className="mt-[clamp(16px,6.9vw,36px)] w-[calc(100%-32px)] max-w-[444px] mx-auto flex flex-col gap-[clamp(16px,6.1vw,32px)] relative z-10">
        <motion.div
